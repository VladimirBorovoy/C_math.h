...
START_TEST(abs_test) {
  int my_inf_int = 1.0 / 0.0;
  int my_min_inf_int = -1.0 / 0.0;
  int zero_int = 0;
  int min_zero_int = -0;
  int small_num_int = 1;
  int min_small_num_int = -1;
  int num_int = 100;
  int min_num_int = -100;
  int big_num_int = 666666;
  int min_big_num_int = -666666;
  ck_assert_int_eq(s21_abs(my_inf), abs(my_inf_int));
  ck_assert_int_eq(s21_abs(my_min_inf), abs(my_min_inf_int));
  ck_assert_int_eq(s21_abs(my_nan), abs((int)my_nan));
  ck_assert_int_eq(s21_abs(min_nan), abs((int)min_nan));
  ck_assert_int_eq(s21_abs(zero), abs(zero_int));
  ck_assert_int_eq(s21_abs(min_zero), abs(min_zero_int));
  ck_assert_int_eq(s21_abs(big_num), abs(big_num_int));
  ck_assert_int_eq(s21_abs(min_big_num), abs(min_big_num_int));
  ck_assert_int_eq(s21_abs(num), abs(num_int));
  ck_assert_int_eq(s21_abs(min_num), abs(min_num_int));
  ck_assert_int_eq(s21_abs(small_num), abs(small_num_int));
  ck_assert_int_eq(s21_abs(min_small_num), abs(min_small_num_int));
}
END_TEST
...
START_TEST(exp_test) {
  ...
  // y = exp(small_num);
  // if (x == y) flag = 1;
  // ck_assert_int_eq(flag, 1);  //  bad test
  // flag = 0;
